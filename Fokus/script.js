...
musicaFocoInput.addEventListener('change', () => {      // O change é bastante usado para checkbox
    if(musica.paused) {
        musica.play()
    } else {
        musica.pause()
...
function iniciar() {
    ...
    play.play()
    intervaloId = setInterval(contagemRegressiva, 1000) // Método para repetir uma função a cada X ms
